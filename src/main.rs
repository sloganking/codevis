...
fn main() {
    ...
    renderer::render(&paths, 100, 16.0 / 9.0, true, true, None, true).expect("No UTF-8 compatible files found.").save("./output.png").unwrap();
    ...
    // render video
        ...
        //     renderer::render(&paths, 100, 16.0 / 9.0, true, false, None, true).expect("No UTF-8 compatible files found.").save(&(file_num + ".png")).unwrap();
